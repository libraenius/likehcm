...
Дважды щёлкните по **`start-dev.bat`** в корне проекта — скрипт сам проверит Node.js и зависимости, при необходимости выполнит `npm install` и запустит dev-сервер на http://localhost:3000. Окно консоли можно не закрывать; для остановки нажмите Ctrl+C.
