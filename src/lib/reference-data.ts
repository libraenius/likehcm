...
const defaultCompetences: Competence[] = [
  ...
  },
  {
    ...
    levels: {
      ...
      level3: "Демонстрирует базовое понимание тенденций рынка, динамики финансовой отрасли и то, чем организация отличается от других. Собирает информацию, чтобы быть в курсе изменений в макроэкономической среде и отрасли. Умеет управлять основными расходами в пределах своей зоны ответственности. Собирает релевантную информацию для выявления потребностей внутренних клиентов, умеет выслушать и понять их потребности и интересы",
      level4: "Регулярно запрашивает обратную связь от внутренних клиентов и использует ее для улучшения своей работы. Внедряет необходимые изменения в своей деятельности в соответствии с изменением стратегических приоритетов бизнеса. Анализирует влияние макроэкономических факторов на деятельность организации и адаптирует свои подходы",
  ...
  },
  {
    ...
    levels: {
      ...
      level3: "Оценивает и верифицирует входящую информацию, собирает и анализирует данные для принятия решений в рамках своей зоны ответственности. Знает и соблюдает внутренние политики и законодательные/нормативные требования к этичному использованию персональных данных",
      level4: "На основе разрозненной информации выделяет ключевые моменты и проблемы, требующие решений. Использует различные источники данных для комплексного анализа ситуации. Применяет методы верификации данных для обеспечения их достоверности",
  ...
  },
  {
    ...
    levels: {
      ...
      level4: "Обладает базовыми знаниями в области внедрения HR технологий, легко ориентируется в новых подходах и практиках. Самостоятельно ищет и использует возможности для саморазвития в цифровой среде. Адаптирует новые цифровые решения под специфику своей работы и обучает коллег их использованию",
  ...
  },
  {
    ...
    levels: {
      ...
      level4: "Своей деятельностью способствует развитию потенциала и благополучию сотрудников. Демонстрирует понимание нормативных рисков, влияющих на деятельность организации. Проактивно создает условия для развития команды и поддерживает инклюзивную рабочую среду",
  ...
  },
  {
    ...
    levels: {
      ...
      level4: "Оперативно реагирует на проблемы, связанные с нестандартными ситуациями. Четко формулирует суть и последствия проблемы. Отслеживает лучшие практики, находит инновационные, прорывные решения для внедрения в рамках своего направления. Управляет сложными проектами с множеством зависимостей",
  ...
  },
  {
    ...
    levels: {
      ...
      level4: "Делится с коллегами экспертизой, консультирует, воспринимается как профессионал. Поддерживает высокую эффективность своей работы в ситуации постоянных изменений. Может находить решения и действовать в условиях неопределенности. Проактивно ищет сложные задачи и берет на себя ответственность за их решение",
    ...
    levels: [
      {
        ...
        experience: "Внутренние соискатели: без опыта работы по профилю деятельности Подразделения, но не менее 1 года работы в ГПБ. Внешние соискатели: опыт работы по профилю деятельности Подразделения не менее 1 года",
        requiredSkills: {
      ...
      },
      {
        ...
        experience: "Внутренние соискатели: опыт работы в должностях специалистов предшествующего иерархического уровня не менее 1 года. Внешние соискатели: опыт работы в финансово-кредитной сфере не менее 1 года, опыт работы по профилю деятельности Подразделения не менее 2 лет",
        requiredSkills: {
...
export function getProfiles(): Profile[] {
  ...
  const updated = stored.map((profile: any) => {
    ...
    if (defaultProfile) {
      ...
      // Это включает education, experience, responsibilities и другие поля
      finalProfile = {
        ...defaultProfile,
