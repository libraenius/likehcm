...
const defaultCompetences: Competence[] = [
  ...
  },
  {
    id: "comp-49",
    name: "Проактивность",
    description: "Способность действовать инициативно, предвидеть проблемы и принимать меры до их возникновения, брать на себя ответственность за результаты",
    type: "корпоративные компетенции",
    levels: {
      level1: "Выполняет поставленные задачи, следует инструкциям, реагирует на указания руководителя",
      level2: "Самостоятельно планирует выполнение задач, выявляет и сообщает о потенциальных проблемах, предлагает простые улучшения",
      level3: "Проактивно выявляет проблемы и предлагает решения, инициирует улучшения процессов, берет на себя дополнительную ответственность",
      level4: "Предвидит проблемы и риски, разрабатывает превентивные меры, инициирует стратегические улучшения, влияет на принятие решений",
      level5: "Создает культуру проактивности в команде, разрабатывает системы предупреждения проблем, трансформирует подходы к работе, менторит других в развитии проактивности",
    },
    resources: {
      literature: [
        { name: "7 навыков высокоэффективных людей - Стивен Кови", level: 3 },
        { name: "Проактивное мышление - Джон Миллер", level: 2 },
        { name: "Принцип проактивности - Стивен Кови", level: 3 },
        { name: "QBQ! Вопрос, меняющий жизнь - Джон Миллер", level: 2 },
        { name: "The Proactive Professional - Кен Бланчард", level: 4 }
      ],
      videos: [
        { name: "Проактивность vs Реактивность - TED", level: 1 },
        { name: "Как развить проактивность - Brian Tracy", level: 2 },
        { name: "Проактивное мышление - MindTools", level: 2 },
        { name: "Taking Initiative - LinkedIn Learning", level: 3 },
        { name: "Proactive Leadership - Harvard Business Review", level: 4 }
      ],
      courses: [
        { name: "Основы проактивности - Stepik", level: 1 },
        { name: "Proactive Thinking - Coursera", level: 2 },
        { name: "Taking Initiative and Ownership - Udemy", level: 3 },
        { name: "Proactive Leadership - edX", level: 4 },
        { name: "Strategic Proactivity - Pluralsight", level: 5 }
      ],
    },
  },
  {
    ...
    description: "Способность выявлять, анализировать и эффективно взаимодействовать с заинтересованными сторонами проекта для достижения целей",
    type: "корпоративные компетенции",
    levels: {
      level1: "Понимает концепцию заинтересованных сторон, знает основных участников проекта, следует инструкциям по взаимодействию",
      level2: "Выявляет основных заинтересованных сторон, понимает их интересы и влияние, поддерживает базовую коммуникацию",
      level3: "Анализирует заинтересованные стороны, управляет их ожиданиями, разрешает конфликты интересов, координирует взаимодействие",
      level4: "Разрабатывает стратегии управления заинтересованными сторонами, влияет на принятие решений, управляет сложными отношениями, обеспечивает поддержку проекта",
      level5: "Создает системы управления заинтересованными сторонами, формирует стратегические партнерства, трансформирует подходы к взаимодействию, менторит других",
    },
    resources: {
      literature: [
        { name: "Управление заинтересованными сторонами - Роджер Берк", level: 3 },
        { name: "Stakeholder Theory - Эдвард Фриман", level: 4 },
        { name: "Managing Stakeholders - Дэвид Бриджес", level: 3 },
        { name: "The Stakeholder Strategy - Энн Сэвидж", level: 4 },
        { name: "Stakeholder Engagement - Дэвид Бриджес", level: 5 }
      ],
      videos: [
        { name: "Stakeholder Management Basics - MindTools", level: 1 },
        { name: "Managing Stakeholders - Project Management Institute", level: 2 },
        { name: "Stakeholder Engagement Strategies - LinkedIn Learning", level: 3 },
        { name: "Advanced Stakeholder Management - Udemy", level: 4 },
        { name: "Strategic Stakeholder Management - Harvard Business Review", level: 5 }
      ],
      courses: [
        { name: "Основы управления заинтересованными сторонами - Stepik", level: 1 },
        { name: "Stakeholder Management - Coursera", level: 2 },
        { name: "Stakeholder Engagement - Udemy", level: 3 },
        { name: "Advanced Stakeholder Management - edX", level: 4 },
        { name: "Strategic Stakeholder Management - Pluralsight", level: 5 }
      ],
    },
  },
  {
...
const defaultProfiles: Profile[] = [
  ...
  },
  {
    ...
    description: "Специалист по анализу бизнес-процессов, выявлению требований и оптимизации бизнес-решений",
    tfr: "бизнес-аналитик",
    requiredCompetences: [], // Будет автоматически сформировано из levels
    levels: [
      {
        ...
        description: "Стажер-бизнес-аналитик. Начальный уровень, изучение основ бизнес-анализа и работы с требованиями под руководством ментора.",
        responsibilities: [
          "Изучение основ бизнес-анализа и работы с требованиями",
          "Выполнение простых задач по сбору и документированию требований под руководством",
          "Изучение базовых техник интервьюирования и работы с заинтересованными сторонами",
          "Освоение работы с документацией и шаблонами спецификаций",
          "Изучение основ моделирования бизнес-процессов",
          "Участие в встречах с заинтересованными сторонами для наблюдения и обучения",
          "Изучение основ работы с инструментами бизнес-анализа",
          "Работа с документацией и изучение существующих процессов",
        ],
        education: "Среднее специальное или неоконченное высшее образование (техническое, экономическое или управленческое)",
        bankExperience: "Стаж работы в банке не требуется",
        externalExperience: "Стаж работы на внешнем рынке не требуется",
        requiredSkills: {
          "comp-47": 1, // Работа с требованиями - начальный уровень
          "comp-9": 1, // Коммуникация - начальный уровень
          "comp-23": 1, // Понимание бизнеса - начальный уровень
          "comp-13": 1, // Управление временем - начальный уровень
        },
        taskExamples: [
          "Под руководством ментора провести интервью с одним заинтересованным лицом для сбора базовых требований к новой функции, записать результаты в шаблон спецификации требований",
          "Изучить существующую документацию по бизнес-процессу \"Оформление кредита\", составить краткое описание процесса в текстовом виде, выявить основные участники процесса",
          "Создать простую таблицу с перечнем требований к мобильному приложению на основе предоставленных материалов, используя шаблон спецификации требований"
        ],
      },
      {
        level: "junior",
        name: "Младший бизнес-аналитик",
        description: "Младший бизнес-аналитик. Базовый уровень, способен выполнять задачи по сбору и документированию требований под минимальным руководством.",
        responsibilities: [
          "Сбор и документирование базовых требований через интервью и анализ",
          "Создание простых спецификаций требований и описаний процессов",
          "Участие в воркшопах по сбору требований",
          "Работа с заинтересованными сторонами для уточнения требований",
          "Создание простых диаграмм процессов (flowchart, простые BPMN)",
          "Отслеживание изменений требований в рамках проекта",
          "Подготовка презентаций и отчетов по результатам анализа",
          "Участие в тестировании на основе требований",
          "Работа с реестром требований",
        ],
        education: "Высшее образование (техническое, экономическое или управленческое) или неоконченное высшее",
        bankExperience: "Опыт работы в банке от 6 месяцев до 1 года",
        externalExperience: "Опыт работы на внешнем рынке от 6 месяцев до 1 года",
        requiredSkills: {
          "comp-47": 2, // Работа с требованиями - базовый уровень
          "comp-48": 1, // UML и моделирование процессов - начальный уровень
          "comp-9": 2, // Коммуникация - базовый уровень
          "comp-50": 2, // Управление заинтересованными сторонами - базовый уровень
          "comp-23": 2, // Понимание бизнеса - базовый уровень
          "comp-12": 2, // Решение проблем - базовый уровень
          "comp-13": 2, // Управление временем - базовый уровень
          "comp-10": 2, // Работа в команде - базовый уровень
        ...
        taskExamples: [
          "Провести серию интервью с 3-4 заинтересованными сторонами для сбора требований к новой функции \"Онлайн-заявка на кредит\", создать детальную спецификацию требований с приоритетами, разработать простые диаграммы вариантов использования",
          "Проанализировать существующий бизнес-процесс \"Обработка заявок клиентов\", выявить узкие места и проблемы, предложить улучшения, создать диаграмму процесса в BPMN нотации",
          "Создать реестр требований для проекта внедрения новой системы, отслеживать изменения требований, готовить отчеты о статусе требований для команды проекта"
        ],
      },
      {
        level: "middle",
        name: "Бизнес-аналитик",
        description: "Бизнес-аналитик среднего уровня. Способен самостоятельно анализировать сложные бизнес-процессы, управлять требованиями и взаимодействовать с различными заинтересованными сторонами.",
        responsibilities: [
          "Эффективный сбор и анализ требований различной сложности",
          "Применение различных техник работы с требованиями (интервью, воркшопы, анализ документов)",
          "Создание детальных спецификаций требований и моделей процессов",
          "Управление приоритетами требований и изменениями",
          "Выявление противоречий и неоднозначностей в требованиях",
          "Моделирование бизнес-процессов с использованием BPMN, UML",
          "Проведение анализа влияния изменений на бизнес-процессы",
          "Валидация требований с заинтересованными сторонами",
          "Участие в проектировании решений на основе требований",
          "Менторинг junior бизнес-аналитиков",
          "Координация работы с требованиями в рамках проекта",
        ],
        education: "Высшее образование (техническое, экономическое или управленческое)",
        bankExperience: "Опыт работы в банке от 1 до 3 лет",
        externalExperience: "Опыт работы на внешнем рынке от 1 до 3 лет",
        requiredSkills: {
          "comp-47": 3, // Работа с требованиями - средний уровень
          "comp-48": 3, // UML и моделирование процессов - средний уровень
          "comp-9": 3, // Коммуникация - средний уровень
          "comp-50": 3, // Управление заинтересованными сторонами - средний уровень
          "comp-23": 3, // Понимание бизнеса - средний уровень
          "comp-12": 3, // Решение проблем - средний уровень
          "comp-15": 3, // Критическое мышление - средний уровень
          "comp-49": 2, // Проактивность - базовый уровень
          "comp-13": 3, // Управление временем - средний уровень
          "comp-10": 3, // Работа в команде - средний уровень
          "comp-24": 2, // Управление данными - базовый уровень
        },
        taskExamples: [
          "Провести комплексный анализ бизнес-процессов отдела кредитования, выявить проблемы и узкие места, разработать предложения по оптимизации, создать детальные модели процессов в BPMN, согласовать изменения с заинтересованными сторонами",
          "Управлять требованиями для проекта внедрения новой системы: провести 5-7 воркшопов с заинтересованными сторонами, создать реестр требований из 100+ пунктов, управлять приоритетами и изменениями, валидировать требования с бизнесом и IT",
          "Разработать детальную спецификацию требований для новой функциональности мобильного приложения: провести интервью с пользователями, создать use cases и user stories, разработать диаграммы последовательности, согласовать требования с продукт-менеджером и разработчиками"
        ],
      },
      {
        level: "senior",
        name: "Старший бизнес-аналитик",
        description: "Старший бизнес-аналитик. Экспертный уровень, способен управлять сложными проектами, разрабатывать стратегии работы с требованиями и принимать архитектурные решения.",
        responsibilities: [
          "Профессиональное управление требованиями на всех этапах жизненного цикла проекта",
          "Разработка стратегий работы с требованиями и методологий",
          "Применение продвинутых техник бизнес-анализа (use cases, user stories, BPMN, UML)",
          "Управление изменениями требований и их влиянием на проект",
          "Проектирование бизнес-архитектуры и оптимизация процессов",
          "Работа с комплексными бизнес-задачами и стратегическое планирование",
          "Проведение технических интервью и оценка кандидатов",
          "Менторинг middle и junior бизнес-аналитиков",
          "Участие в стратегическом планировании продуктов",
          "Взаимодействие с топ-менеджментом и ключевыми стейкхолдерами",
          "Создание стандартов и best practices для команды",
          "Исследование новых методологий и их внедрение",
        ],
        education: "Высшее образование (техническое, экономическое или управленческое)",
        bankExperience: "Опыт работы в банке от 3 до 5 лет",
        externalExperience: "Опыт работы на внешнем рынке от 3 до 5 лет",
        requiredSkills: {
          ...
          "comp-48": 4, // UML и моделирование процессов - продвинутый уровень
          "comp-9": 4, // Коммуникация - продвинутый уровень
          "comp-50": 4, // Управление заинтересованными сторонами - продвинутый уровень
          "comp-23": 4, // Понимание бизнеса - продвинутый уровень
          "comp-12": 4, // Решение проблем - продвинутый уровень
          "comp-15": 4, // Критическое мышление - продвинутый уровень
          "comp-49": 3, // Проактивность - средний уровень
          "comp-13": 4, // Управление временем - продвинутый уровень
          "comp-10": 4, // Работа в команде - продвинутый уровень
          "comp-11": 3, // Лидерство - средний уровень
          "comp-24": 3, // Управление данными - средний уровень
        ...
        taskExamples: [
          "Разработать стратегию трансформации бизнес-процессов организации на 3 года: провести комплексный анализ текущих процессов, спроектировать целевую бизнес-архитектуру, создать план трансформации, управлять портфелем проектов, взаимодействовать с топ-менеджментом",
          "Управлять требованиями для крупного проекта внедрения новой системы: провести 10+ воркшопов с заинтересованными сторонами, создать реестр требований из 200+ пунктов, управлять приоритетами и изменениями, валидировать требования с бизнесом и IT, координировать работу команды аналитиков",
          "Разработать корпоративную методологию работы с требованиями для организации: создать стандарты документирования, процессы управления изменениями, шаблоны спецификаций, обучить 20+ аналитиков, внедрить систему управления требованиями"
        ],
      },
      {
        ...
        description: "Ведущий бизнес-аналитик. Экспертный уровень, отвечает за стратегическое направление бизнес-анализа, разработку методологий и развитие команды аналитиков.",
        responsibilities: [
          "Определение стратегии бизнес-анализа и архитектурного видения",
          "Проектирование масштабируемых бизнес-архитектур",
          "Руководство командой бизнес-аналитиков",
          "Разработка корпоративных методологий и стандартов",
          "Принятие критических бизнес-решений",
          "Участие в стратегическом планировании на уровне организации",
          "Взаимодействие с топ-менеджментом и ключевыми стейкхолдерами",
          "Создание систем управления требованиями и бизнес-архитектурой",
          "Исследование новых методологий и подходов",
          "Менторинг senior аналитиков",
          "Участие в конференциях и развитие профессионального сообщества",
          "Формирование корпоративной культуры бизнес-анализа",
        ],
        education: "Высшее образование (техническое, экономическое или управленческое). Дополнительное образование в области бизнес-анализа приветствуется",
        bankExperience: "Опыт работы в банке от 5 лет",
        externalExperience: "Опыт работы на внешнем рынке от 5 лет. Опыт работы на позициях, включающих руководство командами аналитиков: не менее 3 лет",
        requiredSkills: {
          "comp-47": 5, // Работа с требованиями - экспертный уровень
          "comp-48": 5, // UML и моделирование процессов - экспертный уровень
          "comp-9": 5, // Коммуникация - экспертный уровень
          "comp-50": 5, // Управление заинтересованными сторонами - экспертный уровень
          "comp-23": 5, // Понимание бизнеса - экспертный уровень
          "comp-12": 5, // Решение проблем - экспертный уровень
          "comp-15": 5, // Критическое мышление - экспертный уровень
          "comp-49": 4, // Проактивность - продвинутый уровень
          "comp-13": 5, // Управление временем - экспертный уровень
          "comp-10": 5, // Работа в команде - экспертный уровень
          "comp-11": 5, // Лидерство - экспертный уровень
          "comp-24": 4, // Управление данными - продвинутый уровень
        ...
        taskExamples: [
          "Разработать стратегию трансформации бизнес-архитектуры организации на 5 лет: провести анализ текущего состояния, спроектировать целевую архитектуру, создать план трансформации, управлять портфелем проектов, взаимодействовать с топ-менеджментом",
          "Создать корпоративную методологию бизнес-анализа и управления требованиями: разработать стандарты, процессы, инструменты, обучить 50+ аналитиков, внедрить систему управления требованиями, создать центр экспертизы",
          "Руководить командой из 15 бизнес-аналитиков, разработать стратегию развития команды, управлять бизнес-архитектурными решениями для 10+ проектов одновременно, провести трансформацию процессов работы с требованиями, выступить на конференции с докладом"
        ],
      },
    ],
    experts: [],
